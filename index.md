...
[Polynomial Functors](https://topos.site/poly-course/) |
## Upcoming meeting
| I | II | III | IV | V |
|:---------|:---------------------|:---------------|:---------------|:---------------|
...
[Richard Wong](https://web.ma.utexas.edu/users/richard.wong/) | [Jerzy Weyman](https://math.uconn.edu/person/jerzy-weyman/#) |[Burkhard Külshammer](https://www.minet.uni-jena.de/algebra/personen/kuelshammer.html) |
...
15. 正规化子 N_G(P) 可以理解为 G 中对 P 共轭作用封闭的元素，中心化子 C_G(P) 理解为 G 中对 P 作用平凡的元素。正规子群可以理解为共轭作用下完整轨道的并。融合系和有限群往往考虑的是共轭关系。
