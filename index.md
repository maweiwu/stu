...
[Richard Wong](https://web.ma.utexas.edu/users/richard.wong/) | []() |
...
1. 做数学就像“圈地耕耘”活动，每个人都用自己的方式在整片大地上划出一块“小地方”出来，利用小地方得到一些结果。每个人划的方式和范围不一样，所以就有可能有不一样的交集，不一样的产品表现形式，不管怎样，产品在交集处的本质是一样的。通过交流，大家就会发现彼此研究的关联。每个人的圈地耕耘方式能走多远，产品表现形式如何，这些都是因人而异的。并且圈地耕耘方式可以有千万种，因此每个人都有自己的施展空间，不管是大家还是小人物，并且得到的产品本质上都是一样的。比如研究模范畴，就可以取出各种不同的子模类来研究整个模范畴，并且子模类的取法有千万种，可以利用同调性质等取法。大家使用的工具和语言不一样（每个人“划地”方式不一样），但大家得到的结果是一样的，只是表现形式不一样而已。

2. 理论需要在例子中理解，尽量用具体的例子去编码所学的理论，这样理解才更深刻。此外，可以用例子驱动研究，辅助研究，没有哪套理论是空想出来的。

3. 就算是大家创立的理论，也仅仅是他\她的一种处理方式而已，这并不是唯一的和可能也不是最好的处理方式，所以每个人都可以有自己的独特处理方式。
