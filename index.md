...
[Richard Wong](https://web.ma.utexas.edu/users/richard.wong/) | [Jerzy Weyman](https://math.uconn.edu/person/jerzy-weyman/#) |
...
6. 群表示论/块论不仅仅研究某个固定群的模范畴，而是把所有群的模范畴放在一起来研究(!)；群表示论更多地是从群代数的角度对模范畴进行约化/追踪/分割；而代数表示论则往往直接对模范畴借助同调工具进行操作，往往是对某个固定的代数的模范畴进行研究。 
