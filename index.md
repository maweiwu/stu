...
38. 函子的左右伴随的存在意味着范畴的等价；左右的区别在于范畴等价的方式有所差别：H ——| F ——| G 是伴随函子，[A]=[..., A ,...] 是范畴中的同构类，HFA ——> A 中的HFA取A的“左”边的同构对象，GFA 则取A的“右”边的同构对象。另外，函子是否有左右伴随还因为它对源范畴和目标范畴的（余）极限运算的保持情况不一样，函子性质的“好坏”不同。   
