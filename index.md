...
282. 研究一个对象的其中一个方法就是分析它的内部结构：生成元和生成关系，而同调代数的目的就是为了揭示这些生成元和生成关系。
     ...
     同调代数 “=” 生成元 + 生成关系。
     ```
283. 把有限维代数和Monoid都看成范畴，则这两者的许多理论就非常相似，如A，Ae, eAe和M，Me, eMe以及Recollement理论等。所以可以先把Monoid的情形看清楚就基本理解了有限维代数的情形。可以参看 Benjamin Steinberg，Representation Theory of Finite Monoids，Springer 2016.     
