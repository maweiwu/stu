...
[Things to watch-Mathieu ANEL](http://mathieu.anel.free.fr/index.html) | [Stanford Encyclopedia of Philosophy](https://plato.stanford.edu/) |
...
[Jaap van Oosten](https://webspace.science.uu.nl/~ooste110/index.html) |
...
526. 2-范畴比双(bi-)范畴严格。这些概念要在具体的例子中理解，这样才能看清定义中各个概念的具体含义以及它的必要性。比如利用书中 **Example 2.1.26** 就可以清楚看到2-态射的水平合成和垂直合成是不一样的，而且容易看成双范畴中，往往**水平方向的合成**是比较不自然的。[2-Dimensional Categories](https://arxiv.org/abs/2002.06055)
