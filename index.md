...
509. 既然范畴可以跨越各个学科，那么拓扑空间上的拓扑斯性质就理应能够在代数上产生的拓扑斯得到解释。把拓扑空间上的拓扑斯性质**解释**到代数产生的拓扑斯上去应该是一件非常有意义的事情。所以需要做两件事：熟悉拓扑空间上的拓扑斯已有的各种性质和构造；在代数上产生的拓扑斯中去解释它。Homotopy Type Theory也应该作为应该有用的工具去发掘新理论，我们需要做的也是去**解释**抽象的Type语言。2023-3-24 15:12 于汕大图书馆。
