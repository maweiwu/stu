...
[Software for Representation Theory](https://www.math.arizona.edu/~klux/software.php) |
...
25. 对一般有限群的某些相关信息（结构，数量等）约化到较小的某类群（有限单群，本原群，传递群等）上的相关信息；然后再利用较小群类的分类定理对约化信息（结构，数量等）进行验证。这两步都很重要。 
