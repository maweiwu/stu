...
212. (1) Monad的效果之一是把原范畴扩大，如幂集合函子P: Set —> Set。(2) 对于某个Monad T: C—> C，T的代数可以看成是T在范畴C上的一个解释/模型，此时T相当于语法/逻辑部分。(3) Monadicity是指某个范畴D能否实现为某个Monad的代数范畴的形式。(4) Monad <--互相产生--> 伴随函子对。 
