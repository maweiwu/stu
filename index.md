...
172. 对于一个函子，我们自然会关心的问题是它的作用效果，即它保持和传递了哪部分信息？比如原来的子对象关系或者商对象关系在函子作用后是否会保持？因此会考虑函子的正合性问题。例如左正合函子保持单态射，右正合函子保持满态射，具有右伴随的函子保持余极限等等。分析清楚哪部分态射/结构是被函子保持的对于比较和传输范畴之间的信息至关重要。    
