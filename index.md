...
423. 函子的各种性质：如正合性、伴随性、各种结构的保持性等，本质上是由**函子的构建方式**决定的，所以，研究函子的乐趣就在于分析它的构建方式。层论和拓扑斯理论的各种函子的性质的分析就依赖于对函子构建方式的剖析(Funny!)。见[Stacks Project](https://stacks.math.columbia.edu/)。
