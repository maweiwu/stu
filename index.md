...
130. 对于一个范畴可以考虑其【各种各样不同的】支撑簇/谱(拓扑空间)，不仅仅只有一种支撑簇/谱，借助这些拓扑空间对范畴的信息进行分割。每种支撑簇/谱的对原范畴的分层/控制的效果都不一样，因此可以去比较一下这些不同支撑簇/谱(拓扑空间)对范畴的控制程度。这些拓扑空间为我们提供了一个控制/分析范畴的手段/角度。
